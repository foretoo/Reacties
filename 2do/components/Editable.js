...
class ContentEditable extends React.Component {
  ...
  render() {
    ...
    return React.createElement(tagName || 'div', { ...props,
  ...
  shouldComponentUpdate(nextProps) {
    ...
    const el = this.getEl(); // We need not rerender if the change of props simply reflects the user's edits.
    ...
    return props.disabled !== nextProps.disabled || props.tagName !== nextProps.tagName || props.className !== nextProps.className || props.innerRef !== nextProps.innerRef;
  }
